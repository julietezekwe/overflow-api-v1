...
var Answers = function () {
    ...
    _createClass(Answers, null, [{
        ...
        key: "commentOnAnswer",
        value: function commentOnAnswer(req, res) {
            var answerId = req.params.answerId;
            var _req$authData3 = req.authData,
                id = _req$authData3.id,
                name = _req$authData3.name;
            var body = req.body.body;
        ...
        key: "updateLike",
        value: function updateLike(req, res) {
            var answerId = req.params.answerId;
            ...
            _dbConfig2.default.query(query).then(function (likes) {
                if (likes.rowCount > 0) {

                    var like_id = likes.rows[0].id;
