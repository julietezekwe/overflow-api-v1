...
_dbConfig2.default.query('CREATE TABLE IF NOT EXISTS Answers(id SERIAL PRIMARY KEY, answer TEXT not null, question_id INTEGER not null, user_id INTEGER not null, user_name VARCHAR(100) not null, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, accepted INTEGER not null DEFAULT 0)');