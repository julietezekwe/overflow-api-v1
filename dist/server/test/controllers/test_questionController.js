  ...
  */
  describe('/GET REQUESTS', function () {
    ...
    it('it should not get a user Question if user is not signed in', function (done) {
      ...
      _chai2.default.request(_app2.default).get('/api/v1/question/4/questions').set('Authorization', wrongToken).end(function (err, res) {
        expect(res.body.message).to.eql('Kindly sign in, wrong authentication');
        expect(res.body.error).to.eql(true);
        expect(res.status).to.equal(403);
        done();
    ...
    it('it should not get user\'s question for user without token', function (done) {
      ...
      _chai2.default.request(_app2.default).get('/api/v1/question/4/questions').end(function (err, res) {
        expect(res.body.message).to.eql('Kindly sign in');
        expect(res.body.error).to.eql(true);
        expect(res.status).to.equal(403);
        done();
    ...
    it('it should not get questions that does not exist ', function (done) {
      ...
      _chai2.default.request(_app2.default).get('/api/v1/question/9').end(function (err, res) {
    ...
    it('it should not get questions when the user does not have questions ', function (done) {
      ...
      _chai2.default.request(_app2.default).get('/api/v1/question/9/questions').set('Authorization', authToken).end(function (err, res) {
        expect(res.body.message).to.eql('no questions found');
        expect(res.body.error).to.eql(true);
        expect(res.status).to.equal(400);
        done();
    ...
    it('should get question for user with valid token', function (done) {
      ...
      _chai2.default.request(_app2.default).get('/api/v1/question/4/questions').set('Authorization', authToken).end(function (err, res) {
        expect(res.body.message).to.eql('Success');
  ...
  describe('/DELETE REQUESTS', function () {
    ...
    it('User can only delete its question', function (done) {
    ...
    it('should delete question for user with valid token', function (done) {
      ...
      _chai2.default.request(_app2.default).delete('/api/v1/question/3').set('Authorization', authToken).end(function (err, res) {
