  ...
  */
  describe('/POST REQUESTS', function () {
    ...
    it('it should not post answer for user without token', function (done) {
      ...
      _chai2.default.request(_app2.default).post('/api/v1/question/2/answer').send(answer).end(function (err, res) {
    ...
    it('it should not post answer for user with wrong token', function (done) {
      ...
      _chai2.default.request(_app2.default).post('/api/v1/question/2/answer').set('Authorization', wrongToken).send(answer).end(function (err, res) {
    ...
    it('should post answer for user with valid token and question does not belong to user', function (done) {

      var question = {
        body: "body"
      };
      _chai2.default.request(_app2.default).post('/api/v1/question/2/answer').set('Authorization', authToken).send(question).end(function (err, res) {
    ...
    it('should not post answer for user that owns the question', function (done) {

      var answer = {

        body: "body"
      };
      _chai2.default.request(_app2.default).post('/api/v1/question/1/answer').set('Authorization', authToken).send(answer).end(function (err, res) {
    ...
    it('should not update answer that does not exist', function (done) {

      var answer = {

        body: "body edit"
      };
      _chai2.default.request(_app2.default).put('/api/v1/question/4/answers/50').set('Authorization', authToken).send(answer).end(function (err, res) {
    ...
    it('should update answer for user that owns the answer', function (done) {

      var answer = {

        body: "body edit"
      };
      _chai2.default.request(_app2.default).put('/api/v1/question/2/answers/1').set('Authorization', authToken).send(answer).end(function (err, res) {
    ...
    it('should accept the answer for the question owner', function (done) {
    ...
    it('should not post answer for a question that does not exist', function (done) {

      var answer = {

        body: "body"
      };
      _chai2.default.request(_app2.default).post('/api/v1/question/50/answer').set('Authorization', authToken).send(answer).end(function (err, res) {
  ...
  */
  describe('/GET REQUESTS', function () {
    ...
    it('it should not get answers that does not exist ', function (done) {
      ...
      _chai2.default.request(_app2.default).get('/api/v1/question/50/answers').end(function (err, res) {
    ...
    it('it should get question\' answers ', function (done) {

      _chai2.default.request(_app2.default).get('/api/v1/question/2/answers').end(function (err, res) {
